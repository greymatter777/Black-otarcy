...
interface AuditRecord {
  id: string; brand: string; score: number; analysis: string;
  ...
  return (
    <div onClick={onClick} style={{ padding: "24px 28px", border: "1px solid #2a2a2a", background: "#161616", cursor: "pointer", transition: "border-color 0.25s, background 0.25s", display: "flex", alignItems: "center", gap: "24px" }}
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <h3 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.4rem", letterSpacing: "0.08em", color: "#f0f0f0", marginBottom: "4px" }}>{audit.brand.toUpperCase()}</h3>
        <p style={{ fontFamily: "'Raleway', sans-serif", fontSize: "0.72rem", color: "#7a7a7a", letterSpacing: "0.1em", marginBottom: "8px" }}>{date}</p>
        <p style={{ fontFamily: "'Raleway', sans-serif", fontSize: "0.76rem", color: "#a0a0a0", lineHeight: 1.6, fontWeight: 300, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{audit.analysis}</p>
      </div>
      ...
      <div style={{ background: "#161616", border: "1px solid #2a2a2a", maxWidth: "760px", width: "100%", maxHeight: "85vh", overflowY: "auto", padding: "40px" }} onClick={(e) => e.stopPropagation()}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "32px" }}>
          <div>
            ...
            <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "2.5rem", letterSpacing: "0.08em", color: "#f0f0f0" }}>{audit.brand.toUpperCase()}</h2>
          </div>
          <div style={{ display: "flex", gap: "12px", alignItems: "center" }}>
            <button onClick={() => exportAuditPDF({ ...audit })} style={{ fontFamily: "'Raleway', sans-serif", fontSize: "0.6rem", letterSpacing: "0.2em", textTransform: "uppercase", padding: "8px 16px", border: "1px solid #3a3a3a", background: "transparent", color: "#e8e8e8", cursor: "pointer", transition: "border-color 0.3s" }}
              onMouseEnter={(e) => (e.currentTarget.style.borderColor = "#e8e8e8")}
              onMouseLeave={(e) => (e.currentTarget.style.borderColor = "#3a3a3a")}>↓ PDF</button>
        ...
        <div style={{ display: "flex", gap: "28px", alignItems: "flex-start", marginBottom: "32px", padding: "24px", border: "1px solid #2a2a2a", background: "#0f0f0f" }}>
          ...
          <div>
            <p style={{ fontFamily: "'Raleway', sans-serif", fontSize: "0.6rem", letterSpacing: "0.25em", color: "#7a7a7a", textTransform: "uppercase", marginBottom: "10px" }}>Analyse</p>
            <p style={{ fontFamily: "'Raleway', sans-serif", fontSize: "0.84rem", color: "#d4d4d4", lineHeight: 1.85, fontWeight: 300 }}>{audit.analysis}</p>
          </div>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "16px" }}>
          {[
            ...
            <div key={col.label} style={{ padding: "20px", border: "1px solid #2a2a2a", background: "#0f0f0f" }}>
              <p style={{ fontFamily: "'Raleway', sans-serif", fontSize: "0.58rem", letterSpacing: "0.3em", color: "#7a7a7a", textTransform: "uppercase", marginBottom: "14px" }}>{col.label}</p>
              {col.items.map((item, i) => (
                <div key={i} style={{ display: "flex", gap: "8px", marginBottom: "8px" }}>
                  <span style={{ color: col.color, fontSize: "0.7rem", flexShrink: 0 }}>{col.symbol}</span>
    ...
    <div style={{ background: "#0f0f0f", minHeight: "100vh" }}>
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "28px 36px", background: "rgba(15,15,15,0.85)", backdropFilter: "blur(12px)", borderBottom: "1px solid rgba(255,255,255,0.04)" }}>
        ...
        <div style={{ display: "flex", gap: "24px", alignItems: "center" }}>
          <Link to="/" style={{ fontFamily: "'Raleway', sans-serif", fontSize: "0.7rem", letterSpacing: "0.2em", color: "#7a7a7a", textDecoration: "none", fontWeight: 500 }} onMouseEnter={(e) => (e.currentTarget.style.color = "#e8e8e8")} onMouseLeave={(e) => (e.currentTarget.style.color = "#7a7a7a")}>AUDIT</Link>
      ...
      <div style={{ maxWidth: "860px", margin: "0 auto", padding: "120px 40px 80px" }}>
        ...
        {loading ? (
          ...
          <div style={{ padding: "48px", border: "1px solid #2a2a2a", textAlign: "center" }}>
            ...
            <Link to="/" style={{ fontFamily: "'Raleway', sans-serif", fontSize: "0.66rem", letterSpacing: "0.22em", textTransform: "uppercase", color: "#e8e8e8", textDecoration: "none", padding: "10px 20px", border: "1px solid #3a3a3a" }}>Lancer mon premier audit →</Link>
          </div>
        ) : (
